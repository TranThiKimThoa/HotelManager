                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form action="search" method="post" class="search">
                                <input type="text" class="form-control input-sm" maxlength="64" placeholder="Search by IdCard" name="searchText"/>
                                ...
                                <tbody>
                                    <c:forEach var="c" items="${list}">
                                        <tr class="row100 body">
                                            ...
                                            <td class="cell100 column3"><a href="${pageContext.request.contextPath}/management/employee/states/${c.id}">${c.id}</a></td>
