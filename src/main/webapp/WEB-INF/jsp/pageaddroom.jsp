    ...
    <body>
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <f:form style=" margin-left: 350px; margin-top: 50px;" action="addRoom" method="post" modelAttribute="room" class="container col-md-4 panel panel-primary panel-body" >
                    
                    <div class="panel-heading" style="text-align: center;">Add room</div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="roomNumber" min="0" required/>
                        <f:errors path="roomNumber" cssClass="error" />
                    </div>
                    <div class="form-group">
                        <label >Price: </label>
                        <input type="text" class="form-control" name="price" min="0" required />
                        <f:errors path="price" cssClass="error" />
                    </div>

                    <div class="form-group">
                        <label >Category Room: </label>
                        <select name="roomCa.id" class="form-control">
